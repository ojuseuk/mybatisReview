...
<body>
	...
	<div class="w3-container w3-teal w3-margin-bottom">
		<a href="problemY6.jsp"><span class="w3-left w3-xxlarge">« </span></a> 
		<span style="font-size: 40px; margin-bottom: 15px; margin-left: 100px;">myBatis	기본</span>
		<a href="problemY8.jsp" style="float: right;"><span	class="w3-right w3-xxlarge">»</span></a>
	</div>
	<br>
	<br>
		...
		<div class="w3-twothird">
         ...
         <img src="../img/problemO9.PNG" style="width: 100%">
          -->
			...
			<h1>Q. myBatis의 주요 API 중 SQL 문장을 처리하는 객체를 고르세요</h1>
			...
			<table class="w3-table w3-striped w3-bordered w3-border" border="1">
				...
				<tr>
					<td>
						<input type="radio" name="q7" value="a1" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSessionFactoryBuilder<br>
					</td>
					<td rowspan="3" style="text-align: center; vertical-align: middle">
					<button id="checkBtn">확인</button></td>
					<td rowspan="3" id="problem07_Answer"style="text-align: center; vertical-align: middle"></td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="q7" value="a2" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSessionFactory<br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="q7" value="a3" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSession<br>
					</td>
				</tr>
		...
		<div class="w3-third">
	        <h1>힌트</h1>
         	...
         	<div style="display: none;" id="ViewHint">
         		<a href="http://www.mybatis.org/mybatis-3/ko/java-api.html">myBatis</a>
         	</div>
         	<br><br><br><br><br>
         	<div>
	...
	document.getElementById("checkBtn").addEventListener("click", function(e) {
		if(answer=="a3"){
			document.getElementById("problem07_Answer").innerHTML = "<span style='color:green'>정답</span>";
		} else {
			document.getElementById("problem07_Answer").innerHTML = "<span style='color:red'>오답</span>";
		}
	});
