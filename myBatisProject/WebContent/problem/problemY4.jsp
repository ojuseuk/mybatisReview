...
<body>
	...
	<div class="w3-container w3-teal w3-margin-bottom">
		<a href="problemY3.jsp"><span class="w3-left w3-xxlarge">« </span></a> 
		<span style="font-size: 40px; margin-bottom: 15px; margin-left: 100px;">myBatis	기본</span>
		<a href="problemY5.jsp" style="float: right;"><span	class="w3-right w3-xxlarge">»</span></a>
	</div>
	<br>
	<br>
		...
		<div class="w3-twothird">
         ...
         <img src="../img/problemO9.PNG" style="width: 100%">
          -->
			...
			<h1>Q. myBatis의 주요 API가 아닌 것을 고르세요</h1>
			...
			<table class="w3-table w3-striped w3-bordered w3-border" border="1">
				...
				<tr>
					<td>
						<input type="radio" name="q4" value="a1" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSessionFactoryBuilder<br>
					</td>
					<td rowspan="4" style="text-align: center; vertical-align: middle">
					<button id="checkBtn">확인</button></td>
					<td rowspan="4" id="problem02_Answer"style="text-align: center; vertical-align: middle"></td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="q4" value="a2" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSessionFactory<br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="q4" value="a3" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSessionBuilder<br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" name="q4" value="a4" onclick="checkedAnswer(this.value)">
						&nbsp;SqlSession<br>
					</td>
				</tr>
			</table>
